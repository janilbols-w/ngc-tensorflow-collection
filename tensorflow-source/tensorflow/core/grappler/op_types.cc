...
bool IsFusedLayerNormGrad(const NodeDef& node) {
  return node.op() == "FusedLayerNormGrad";
}

bool IsFusedInstanceNormGrad(const NodeDef& node) {
  return node.op() == "FusedInstanceNormGrad";
}
