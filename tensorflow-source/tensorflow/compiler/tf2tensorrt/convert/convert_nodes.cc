...
Status Converter::BuildCudaEngine(
  ...
  static SparseComputeMode sparse_compute_mode = [](bool _enable_sparse_compute)
  {
    ...
    artificially introduce a sparse weight pattern compatible with Sparse
    TensorCores of NVIDIA Ampere GPU architecture. It will complete corrupt
    the numerical values of the computation, it shall only be used to evaluate
    the benefit of using sparse computation for inference*/
