...
class TrtGraphConverterV2(object):
  ...
  def summary(self, line_length=160, detailed=True, print_fn=None):
    ...
    print_row(headers, positions, print_fn=print_fn)
    ...
    for node in graphdef.node:
      if node.op != "TRTEngineOp":
        ...
        # TODO: broken https://github.com/tensorflow/tensorflow/issues/52934
        ...
        print_row(
            [node.name, node_count, in_dtypes, out_dtypes, in_shapes],
            positions,
            print_fn=print_fn
        )
        if detailed:
