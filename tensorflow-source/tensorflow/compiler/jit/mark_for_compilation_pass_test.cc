...
TEST(XlaCompilationTest, XLALiteWhitelist) {
  ...
  absl::flat_hash_set<string> known_not_in_list = tensorflow::testing::GetKnownXLAWhitelistOp();
  ...
  EXPECT_TRUE(unknow_op.empty())
    << "Someone added support for a new TF opeations inside XLA. They must be included in the XLALite whitelist or blacklist:\n"
