...
AsyncOutSendThunk::AsyncOutSendThunk(ThunkInfo thunk_info,
                                     ShapedSlice source_slice, std::string key)
...
Status AsyncOutSendThunk::ExecuteOnStream(const ExecuteParams& params) {
  ...
  se::DeviceMemoryBase addr = buffer_allocations.GetDeviceAddress(source_slice);
