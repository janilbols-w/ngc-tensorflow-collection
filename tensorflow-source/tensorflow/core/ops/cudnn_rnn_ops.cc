...
REGISTER_OP("CudnnRNNParamsSizeV2")
    .Input("num_layers: int32")
    .Input("num_units: int32")
    .Input("input_size: int32")
    .Attr("T: {float16, float32, float64}")
...
REGISTER_OP("CudnnRNNBackpropV4")
    .Input("input: T")
    .Input("input_h: T")
    .Input("input_c: T")
    .Input("params: T")
...
REGISTER_OP("CudnnRNNParamsToCanonicalV2")
    ...
    .Output("biases: num_params_bias * T")
    .Attr("T: {float16, float32, float64}")
    .Attr("num_params_weights: int")
    .Attr("num_params_bias: int")
    .Attr(kRNNModeAttrs)
    .Attr(kRNNInputModeAttrs)
    .Attr(kRNNDirectionAttrs)
    .Attr("dropout: float = 0.0")
    ...
    .SetShapeFn([](InferenceContext* c) {
      ...
      TF_RETURN_IF_ERROR(c->GetAttr("num_params_bias", &num_params_bias));
      // Set shape for weight matrices
      ...
      // Set shape for bias vectors
      for (int i = 0; i < num_params_bias; i++) {
...
REGISTER_OP("CudnnRNNCanonicalToParamsV2")
    ...
    .Input("biases: num_params_bias * T")
    .Output("params: T")
    .Attr("T: {float16, float32, float64}")
    .Attr("num_params_weights: int")
    .Attr("num_params_bias: int")
