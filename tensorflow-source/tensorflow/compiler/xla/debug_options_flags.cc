...
DebugOptions DefaultDebugOptionsIgnoringFlags() {
  ...
  opts.set_xla_gpu_enable_redzone_check(false);
#ifdef ENABLE_MKL
...
static void AllocateFlags() {
  ...
  flag_objects->push_back(tensorflow::Flag(
      "xla_gpu_enable_redzone_check",
      bool_setter_for(&DebugOptions::set_xla_gpu_enable_redzone_check),
      flag_values->xla_gpu_enable_redzone_check(),
      "By default, XLA will disable the redzone check. Set this flag to true "
      "to enable it."));
  flag_objects->push_back(tensorflow::Flag(
