...
static inline int64 GetBlasWorkspaceLimit(const string& envvar_in_mb,
...
class BatchMatmulParameters {
 public:
  BatchMatmulParameters(bool trans_a, bool trans_b, bool adj_a, bool adj_b,
    ...
    hash_code_ = Hash64Combine(hash_code_, has_bias);
    hash_code_ = Hash64Combine(hash_code_, has_activation);
  }
...
static inline bool GetBlasComputationType(
    const DataType& dtype, bool allow_tf32,
