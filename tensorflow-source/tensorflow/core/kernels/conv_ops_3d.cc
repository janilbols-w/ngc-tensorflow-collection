...
bool DoAutotuneConvolveConfigs(
    ...
    se::DeviceMemory<T>& output_ptr_rz, int64 ConvolveScratchSize,
  ...
  static void launch(OpKernelContext* ctx, bool cudnn_use_autotune,
    ...
    if (cudnn_use_autotune && !AutoTuneConv3d::GetInstance()->FindBasedOnScore(
      ...
      bool found_working_config = DoAutotuneConvolveConfigs<T>(
          ...
          output_desc, tf_allocator_adapter, rz_allocator, output_ptr_rz,
      ...
      if (CudnnUseFrontend()) {
        ...
        LogConvAutotuneResults(
            ...
            input_ptr, filter_ptr, output_ptr, input_desc, filter_desc,
