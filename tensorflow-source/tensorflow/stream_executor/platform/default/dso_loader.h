...
#if CUDA_CUTENSOR
// The following method tries to dlopen necessary cuTENSOR library when
// this library should be dynamically loaded. Error status is returned when
// any of the library cannot be dlopened.
port::Status MaybeTryDlopenCUTENSORLibrary();
#endif
