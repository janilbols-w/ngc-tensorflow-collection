...
StreamExecutor::createRnnVariableSequenceTensorDescriptor(int seq_length,
  ...
  return dnn_support->createRnnVariableSequenceTensorDescriptor(seq_length, batch_size,
