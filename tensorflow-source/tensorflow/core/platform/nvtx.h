...
static bool NvtxRangesDetailedEnabled() {
  static bool is_enabled = [] {
...
static string DataTypeToNumpyString(DataType dtype) {
...
static string AttrValueToJson(const AttrValue& attr_value) {
...
static nvtxRangeId_t MaybeNvtxRangeStart(string node_op, string node_name) {
...
static void MaybeNvtxRangeEnd(nvtxRangeId_t nvtx_range) {
  if (NvtxRangesEnabled() || NvtxRangesDetailedEnabled()) {
...
static nvtxRangeId_t MaybeNvtxDomainRangeStartMsg(string msg, string node_op) {
  nvtxRangeId_t nvtx_range;
  if (NvtxRangesEnabled() || NvtxRangesDetailedEnabled()) {
    nvtx_range = nvtxRangeStartHelper(msg.c_str(), node_op.c_str(),
...
static void MaybeNvtxDomainRangeEnd(nvtxRangeId_t nvtx_range) {
  if (NvtxRangesEnabled() || NvtxRangesDetailedEnabled()) {
