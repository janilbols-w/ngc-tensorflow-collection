...
// The following two tests are not supported when GPU's are present.
// Commenting them out to avoid running them even with the CPU test,
// since we run that test on GPU-equipped machines.
