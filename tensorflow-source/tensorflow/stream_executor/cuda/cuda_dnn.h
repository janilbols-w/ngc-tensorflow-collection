...
class CudnnMhaDescriptor;
class CudnnMhaSeqDataDescriptor;
...
class CudnnSupport : public dnn::DnnSupport {
 public:
  ...
  port::StatusOr<std::unique_ptr<dnn::MhaDescriptor>> createMhaDescriptor(
      int num_heads, int batch_size, int q_size, int k_size, int v_size,
      int q_proj_size, int k_proj_size, int v_proj_size, int o_proj_size,
      int seq_len_q, int seq_len_k, dnn::DataType data_type,
      dnn::DataType comp_prec, float dropout_rate, bool is_proj_bias,
      uint64 seed, ScratchAllocator* state_allocator) override;

  port::StatusOr<std::unique_ptr<dnn::MhaSeqDataDescriptor>>
  createMhaSeqDataDescriptor(int batch_size, int max_seq_length, int vect_size,
                             int seq_array_size,
  ...
  bool DoMhaForward(Stream* stream, const dnn::MhaDescriptor& mha_desc,
                    ...
                    DeviceMemory<Eigen::half>* output_data, int seq_len_q,
                    int seq_len_k, bool is_training, bool residual_link,
  ...
  bool DoMhaForward(Stream* stream, const dnn::MhaDescriptor& mha_desc,
                    ...
                    const dnn::MhaSeqDataDescriptor& output_desc,
                    DeviceMemory<double>* output_data, int seq_len_q,
                    int seq_len_k, bool is_training, bool residual_link,
                    ScratchAllocator* reserve_space_allocator,
                    ScratchAllocator* workspace_allocator) override;
  ...
  bool DoMhaBackward(Stream* stream, const dnn::MhaDescriptor& mha_desc,
                     const dnn::MhaSeqDataDescriptor& input_q_desc,
                     const DeviceMemory<double>& input_q_data,
                     const dnn::MhaSeqDataDescriptor& input_k_desc,
                     const DeviceMemory<double>& input_k_data,
                     ...
                     DeviceMemory<double>* params_backprop_data, int seq_len_q,
  ...
  bool DoMhaBackward(Stream* stream, const dnn::MhaDescriptor& mha_desc,
                     ...
                     DeviceMemory<float>* params_backprop_data, int seq_len_q,
                     int seq_len_k, DeviceMemory<uint8>* reserve_space_uint8,
                     ScratchAllocator* workspace_allocator) override;
 ...
 private:
  ...
  template <class T>
  port::Status DoMhaForwardImpl(Stream* stream,
                                const CudnnMhaDescriptor& mha_desc,
                                ...
                                const DeviceMemory<int>& seq_lengths_qo_data,
                                const DeviceMemory<int>& seq_lengths_kv_data,
                                DeviceMemory<T>* params_data,
                                const CudnnMhaSeqDataDescriptor& output_desc,
                                DeviceMemory<T>* output_data, int seq_len_q,
  ...
  template <class T>
  port::Status DoMhaBackwardImpl(Stream* stream,
                                 const CudnnMhaDescriptor& mha_desc,
                                 const CudnnMhaSeqDataDescriptor& input_q_desc,
                                 const DeviceMemory<T>& input_q_data,
                                 const CudnnMhaSeqDataDescriptor& input_k_desc,
